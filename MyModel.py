...
class MyModel(object):
    ...
    def __init__(self, bucket, model_key, network_key, transform_key=None):
        ...
        self.loaded = False
        self.model = None
        self.s3 = connect_s3.ConnectS3(bucket, model_key, network_key, transform_key)
...
# aa = MyModel("kubeflow-anonymous-test", "pytorch/2020-03-10T14-17-29Z/pytorch", "pytorch/2020-03-10T14-17-29Z/network")
# tt = np.array(tt)
# print(aa.predict(tt))
# print(aa.tags())
